...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      "OPTIONAL", "DOT", "NUMBER", "MODEL_TYPE", "ID", "REFERENCE", 
                      "FILENAME", "COMMENT", "LINE_COMMENT", "WS" ];
...
StopParser.DOT = 39;
StopParser.NUMBER = 40;
StopParser.MODEL_TYPE = 41;
StopParser.ID = 42;
StopParser.REFERENCE = 43;
StopParser.FILENAME = 44;
...
Async_source_mapping_parameter_renameContext.prototype.REFERENCE = function() {
    return this.getToken(StopParser.REFERENCE, 0);
};
...
StopParser.prototype.async_source_mapping_parameter_rename = function() {
    ...
    try {
        ...
        this.state = 244;
        _la = this._input.LA(1);
        if(!(_la===StopParser.ID || _la===StopParser.REFERENCE)) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
