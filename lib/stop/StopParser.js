...
StopParser.OPTIONAL = 32;
StopParser.NUMBER = 33;
StopParser.MODEL_TYPE = 34;
StopParser.ID = 35;
StopParser.FILENAME = 36;
StopParser.COMMENT = 37;
StopParser.LINE_COMMENT = 38;
StopParser.WS = 39;
...
StopParser.prototype.block = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 6)) & ~0x1f) == 0 && ((1 << (_la - 6)) & ((1 << (StopParser.T__5 - 6)) | (1 << (StopParser.T__6 - 6)) | (1 << (StopParser.T__7 - 6)) | (1 << (StopParser.T__8 - 6)) | (1 << (StopParser.T__9 - 6)) | (1 << (StopParser.T__10 - 6)) | (1 << (StopParser.T__11 - 6)) | (1 << (StopParser.T__12 - 6)) | (1 << (StopParser.T__13 - 6)) | (1 << (StopParser.T__14 - 6)) | (1 << (StopParser.T__15 - 6)) | (1 << (StopParser.T__16 - 6)) | (1 << (StopParser.T__17 - 6)) | (1 << (StopParser.T__18 - 6)) | (1 << (StopParser.T__19 - 6)) | (1 << (StopParser.T__20 - 6)) | (1 << (StopParser.T__21 - 6)) | (1 << (StopParser.TRANSITION_OP - 6)) | (1 << (StopParser.OPTIONAL - 6)) | (1 << (StopParser.MODEL_TYPE - 6)))) !== 0)) {
            this.state = 103;
            this.statement();
            this.state = 105;
            this._errHandler.sync(this);
...
StopParser.prototype.block_with_timeout = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 6)) & ~0x1f) == 0 && ((1 << (_la - 6)) & ((1 << (StopParser.T__5 - 6)) | (1 << (StopParser.T__6 - 6)) | (1 << (StopParser.T__7 - 6)) | (1 << (StopParser.T__8 - 6)) | (1 << (StopParser.T__9 - 6)) | (1 << (StopParser.T__10 - 6)) | (1 << (StopParser.T__11 - 6)) | (1 << (StopParser.T__12 - 6)) | (1 << (StopParser.T__13 - 6)) | (1 << (StopParser.T__14 - 6)) | (1 << (StopParser.T__15 - 6)) | (1 << (StopParser.T__16 - 6)) | (1 << (StopParser.T__17 - 6)) | (1 << (StopParser.T__18 - 6)) | (1 << (StopParser.T__19 - 6)) | (1 << (StopParser.T__20 - 6)) | (1 << (StopParser.T__21 - 6)) | (1 << (StopParser.T__25 - 6)) | (1 << (StopParser.TRANSITION_OP - 6)) | (1 << (StopParser.OPTIONAL - 6)) | (1 << (StopParser.MODEL_TYPE - 6)))) !== 0)) {
            this.state = 120;
