...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      "NUMBER", "ID", "MODEL_TYPE", "ENUM_VALUE", "FILENAME", 
...
Enum_valueContext.prototype.ENUM_VALUE = function() {
    return this.getToken(StopParser.ENUM_VALUE, 0);
};
...
StopParser.prototype.enum_value = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 176;
        this.match(StopParser.ENUM_VALUE);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
StopParser.prototype.enumeration = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(_la===StopParser.ENUM_VALUE);
        this.state = 186;
        this.match(StopParser.T__4);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
